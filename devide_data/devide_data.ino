...
int main(int argc, char **argv)
{
    ...
    //uint8_t test_data [] = "";
    ...
    for(i=0; i<nlevel; i++)
    {
        ...
        else if(length_data == 584 && nlevel == 1){
          memcpy(comp_buffer, test_data + idx, idx_normal * sizeof(uint8_t));
          idx = idx + 583;
        }
        else{
