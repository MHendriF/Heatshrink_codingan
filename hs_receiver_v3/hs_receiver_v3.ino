...
int main(int argc, char **argv)
{
    ...
    char incomingByte;
    char buf[20];
    char *s, *orig_sz, *window_sz, *lookahead_sz, *decoder_sz, *polled_sz, *node_type;
    int idx=0, i=0, j=0, orig=0, window=0, lookahead=0, decoder=0, node=0;
    int num[BUFFER_SIZE];
